      	...
      	success:function(respuesta){
	          ...
	          '<div class="col-xs-12 col-sm-6" style="padding-right:0px">'+
	            ...
	            '<div class="input-group">'+
	              ...
	              '<select class="form-control select2 nuevaDescripcionProducto " style="width: 100%;"  id="producto'+numProducto+'" idProducto name="nuevaDescripcionProducto" required>'+
